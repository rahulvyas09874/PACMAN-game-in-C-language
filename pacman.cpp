...
outtextxy(midx,110,"You goal:- To eatup all the POWER      ");
outtextxy(midx,130,"           COOKIES scattered throughtout the MAZE  ");
outtextxy(midx,170,"Your task is not EASY There are 5 GHOSTS chasing you     ");
outtextxy(midx,210,"The Eater.You have to watch out for the GHOSTS ");
outtextxy(midx,250,"To help you ,we have bestowed the PacMan with 3 LIVES");
outtextxy(midx,290,"You can move around the MAZE  using arrow keys       ");
outtextxy(midx,330,"If you are ready to start, press any  key");
setcolor(GREEN);
settextstyle (DEFAULT_FONT,HORIZ_DIR,3);
outtextxy(midx,400,"RAHUL AND RIBHAV wishes you Best of luck");
